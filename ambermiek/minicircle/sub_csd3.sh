...
#SBATCH --mail-user=michael.selby@oriel.ox.ac.uk
...
module load /usr/local/software/modulefiles/amber/16-gpu
#! Full path to application executable: 
application="/usr/local/software/modulefiles/amber/16-gpu"
