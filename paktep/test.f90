program test
  ...
  real, dimension(:), allocatable :: x1,y1,z1,x2,y2,z2,ss,corr
  ...
  call twist_writhe_xyz(bp,1000,x1,y1,z1,x2,y2,z2,corr,ss,twist_integral,writhe_integral,circular)
  ...
  call twist_writhe_xyz(bpa,1000,x1a,y1a,z1a,x2a,y2a,z2a,corr,ss,twist_integrala,writhe_integrala,circulara)
